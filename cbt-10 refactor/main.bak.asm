...
/*stackpointer init*/
	...
	push tmpregl
	sbi PORTB,P_MOSI
	loadTXdata LCD_nop,SPI_TX_data,tmpregl
	pop tmpregl
	dec tmpregl
	brne clr_scr
	;-------------------------------
	...
	;LCD_write Strelka,SPI_TX_data

	;LCD_incY
	;LCD_write Strelka1,SPI_TX_data
